	...
	public static function get_column_defaults() {
		if ( empty( self::$column_defaults ) ) {
			...
			self::$column_defaults = [
				...
				'image'      => [
					'heading'  => __( 'Obraz', 'posts-data-table' ),
					'priority' => 6,
					'width'    => ''
				],
				'title'      => [
					'heading'  => __( 'Tytuł', 'posts-data-table' ),
					'priority' => 1,
					'width'    => ''
				],
				'categories' => [
					'heading'  => __( 'Region', 'posts-data-table' ),
					'priority' => 7,
					'width'    => ''
				],
				'tags'       => [
					'heading'  => __( 'Tagi', 'posts-data-table' ),
					'priority' => 8,
					'width'    => ''
				],
				'date'       => [
					'heading'  => __( 'Data', 'posts-data-table' ),
					'priority' => 2,
					'width'    => ''
				],
				'author'     => [
					'heading'  => __( 'Autor', 'posts-data-table' ),
					'priority' => 4,
					'width'    => ''
				],
				'content'    => [
					'heading'  => __( 'Zawartość', 'posts-data-table' ),
					'priority' => 5,
					'width'    => ''
				]
			];
